...
export interface SupaQueryConfig<TTable extends TableNames = TableNames, TParams = any> {
  table: TTable;
  params?: TParams;
...
export function useSupaWR<T, TTable extends TableNames, TParams = any>(
  config: SupaQueryConfig<TTable, TParams> & {
